...
- headerの内容を*c{header_filename}.pxd*に，ほぼコピー. これでCの実装が.pyxで使える
...
- [サンプル](https://github.com/kzky/languages/tree/master/cython/tutorial/numpy)を書いた，アレイのサイズが大きくなれば型付けによる高速化が効いてきてかなり早くなる．
