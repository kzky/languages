...
class Classifier(object):
    ...
    def _learn_ovo(self, X, y):
        ...
        for pair in self.pairs:
            ...
            # pass (X, y) to binary classifier
            model = self.create_binary_classifier()
            model.learn(X_pair, y_pair)
    ...
    def validate_in_ssl(self, X, y, X_v, y_v, param_grid=[{}]):
        """
        ...
        classifier = validator.validate(X, y, X_v, y_v)
