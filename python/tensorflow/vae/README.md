...
Learning is very unstable, it gets nan very easily based on my reproduction, depending on the initial value of weights. If the initial value of weights is small enouph, i.e., 0.5 x random gaussina.
