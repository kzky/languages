...
# arguemnts for ssl
base_paths = [
    "/home/kzk/datasets/uci_csv_ssl_lrate_fixed_subset_1_30_1_68",
]
output_path = "/home/kzk/experiment/final_paper_2015/results_test/lrate_fixed_with_1.pkl"
classifiers_info = {
    "hpfssl": {
    ...
    "rvm": {
        ...
        "param_grid": [{"max_itr": 50, "threshold": 1e-4,
                        "learn_type": "batch", "alpha_threshold": 1e-12}],
    },
